...
function(rtcx_embed_blob TARGET)
  ...
  if(NOT ARG_ID OR NOT ARG_FILE OR NOT ARG_DEST)
  ...
  if(ARG_ARRAY_IDS)
    ...
    set_property(TARGET ${TARGET}__embed_props APPEND PROPERTY EMBED_ARRAY_IDS ${ARG_ARRAY_IDS})
    set_property(TARGET ${TARGET}__embed_props APPEND PROPERTY EMBED_ARRAY_VALUES
                                                               ${ARG_ARRAY_VALUES})
  endif()

  if(ARG_FILE MATCHES "\\$<TARGET_OBJECTS:([^>]+)>")
    # If the file is a generator expression for target objects add as dependency
    set_property(TARGET ${TARGET}__embed_props APPEND PROPERTY EMBED_TARGET_DEPS
                                                               $<TARGET_OBJECTS:${CMAKE_MATCH_1}>)
    ...
    set_property(TARGET ${TARGET}__embed_props APPEND PROPERTY EMBED_TARGET_DEP_NAMES
                                                               ${CMAKE_MATCH_1})
  else()
  ...
  set_property(TARGET ${TARGET}__embed_props APPEND PROPERTY EMBED_SOURCE_FILE_IDS ${ARG_ID})
  set_property(TARGET ${TARGET}__embed_props APPEND PROPERTY EMBED_SOURCE_FILES ${ARG_FILE})
  set_property(TARGET ${TARGET}__embed_props APPEND PROPERTY EMBED_SOURCE_FILE_DESTS ${ARG_DEST})
